...
class ReactActivityDelegateWrapper(
    ...
    override fun loadApp(appKey: String?) {
        ...
        if (rootViewContainer != null) {
            val mReactDelegate =
                ReactActivityDelegate::class.java.getDeclaredField("mReactDelegate")
        ...
        if (delayLoadAppHandler != null) {
            ...
            delayLoadAppHandler.whenReady {
                ...
                invokeDelegateMethod<Unit, String?>(
                    "loadApp",
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (newDelegate != null && newDelegate != this) {
            ...
            invokeDelegateMethod<Unit, Bundle?>(
                "onCreate",
    ...
    override fun onKeyLongPress(keyCode: Int, event: KeyEvent?): Boolean {
        ...
        return reactActivityHandlers
            ...
            .fold(false) { accu, current -> accu || current } || delegate.onKeyLongPress(
            keyCode,
            event
        )
    }
