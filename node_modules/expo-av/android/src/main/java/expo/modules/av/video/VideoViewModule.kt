            ...
            ViewUtils.tryRunWithVideoView(
                ...
                object : ViewUtils.VideoViewCallback {
                    override fun runWithVideoView(videoView: VideoView) {
                        val listener =
                            object : FullscreenVideoPlayerPresentationChangeProgressListener() {
                                ...
                                override fun onFullscreenPlayerPresentationTriedToInterrupt() {
                                    promise.reject(
                                        "E_FULLSCREEN_VIDEO_PLAYER",
                                        "This presentation change tries to interrupt an older request. Await the old request and then try again.",
                                        null
                                    )
                                }
                                ...
                                override fun onFullscreenPlayerPresentationError(errorMessage: String?) {
                                    ...
                                    promise.reject(
                                        "E_FULLSCREEN_VIDEO_PLAYER",
                                        rejectionMessageBuilder.toString(),
                                        null
                                    )
                                }
                            }
