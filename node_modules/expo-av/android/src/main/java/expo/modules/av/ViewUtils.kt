...
object ViewUtils {
    ...
    @UiThread
    private fun tryRunWithVideoViewOnUiThread(
        moduleRegistry: ModuleRegistry,
        viewTag: Int,
        callback: VideoViewCallback,
        promise: Promise
    ) {
        try {
            val videoWrapperView = moduleRegistry.getModule(UIManager::class.java)
