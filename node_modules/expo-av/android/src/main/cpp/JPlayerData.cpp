    ...
    namespace av {
        ...
        void JPlayerData::registerNatives() {
            registerHybrid({
                                   ...
                                   makeNativeMethod("sampleBufferCallback",
        ...
        void JPlayerData::sampleBufferCallback(jni::alias_ref <jni::JArrayByte> sampleBuffer,
            ...
            try {
                ...
                auto message =
                        "Sample Buffer Callback threw an error! " + std::string(exception.what());
        ...
        void
        JPlayerData::setSampleBufferCallback(const SampleBufferCallback &&sampleBufferCallback) {
