...
NSMapTable<id, NSNumber *> *
activeModules;
@property(nonatomic, strong)
NSMapTable<id, NSString *> *
moduleCategory;
@property(nonatomic, strong)
NSMapTable<id, NSNumber *> *
moduleCategoryOptions;
@property(nonatomic, strong)
NSArray<AVAudioSessionPortDescription *>*
availableInputs;
...
- (NSError *)setCategory:(NSString *)category withOptions:(AVAudioSessionCategoryOptions)options forModule:(id)module {
    ...
    BOOL newSettingsAreDifferent =
            !oldSettingsWerePresent || ![overridenCategory isEqualToString:category] ||
            ([overridenOptions unsignedIntegerValue] != options);
...
<AVAudioSessionPortDescription *>*)availableInputs
{
