...
- (void)installJSIBindingsForRuntime:(void *)jsRuntimePtr
                 withSoundDictionary:(NSMutableDictionary

<NSNumber *, EXAVPlayerData *> *)soundDictionary
{
    ...
    auto setAudioSampleCallback = [weakCallInvoker, weakSoundDictionary](jsi::Runtime &runtime,
        ...
        if (argsCount > 1 && args[1].isObject()) {
            ...
            auto wrapper = std::make_unique<AudioSampleCallbackWrapper>(std::move(callback),
                                                                        runtime, strongCallInvoker);
            EXAudioSampleCallback *objcWrapper = [[EXAudioSampleCallback alloc] initWithCallbackWrapper:(std::move(
                    wrapper))];
    ...
    runtime.global().setProperty(
            ...
            jsi::Object::createFromHostObject(runtime,
                                              std::make_shared<CleanupOnDestroyHostObject>()));
}
